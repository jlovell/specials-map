...
class SpecialsControllerTest < ActionController::TestCase
  ...
  test "should create special" do
    assert_difference('Special.count') do
      post :create, special: { day: @special.day, drink: @special.drink, event: @special.event, food: @special.food }
    end
  ...
  test "should update special" do
    put :update, id: @special, special: { day: @special.day, drink: @special.drink, event: @special.event, food: @special.food }
    assert_redirected_to special_path(assigns(:special))
  end
